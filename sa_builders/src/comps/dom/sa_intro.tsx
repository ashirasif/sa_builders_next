    ...
    return (
        <div className="w-full h-screen overflow-hidden lg:flex lg:flex-row lg:items-center lg:justify-start group">
            <div className={'relative border-l-8 border-primary h-full pl-4 p-8 lg:h-auto lg:transition-all lg:duration-1000' + (showDet?' lg:animate-none animate-back-left lg:basis-full lg:group-hover:translate-x-44': ' lg:animate-none animate-go-left lg:basis-1/3')}>
                ...
                <ul className='text-gray-300 mt-4 lg:text-gray-500'>
                    ...
                    <li><a onClick={() => setShowDet(false)}className="hover:text-white hover:after:content-['_\27F6'] after:text-white transition-all duration-200">Luxary Offices</a></li>
            ...
            <div className={'h-screen relative left-[100vw] -top-[100vh] p-8 lg:static transition-all duration-1000' + (showDet?' animate-go-right lg:animate-none lg:basis-0 lg:hidden':' lg:basis-2/3 animate-back-right lg:animate-none lg:block')}>
                <button className="text-primary p-2 transition-all duration-200 mb-4 text-2xl hover:text-black hover:bg-primary hover:rounded-lg before:content-['<--'] before:text-primary before:text-2xl hover:before:text-black lg:before:content-['\2297']" onClick={() => setShowDet(true)}></button>
                <div className='flex flex-col justify-center space-y-6 items-center'>
                    <img src="https://i.pinimg.com/564x/e2/15/8d/e2158d9a47aed9dedf9e5ead757445d5.jpg" alt="apartment" className='aspect-square w-72 border-primary border-2' />
