    ...
    <nav className="bg-transparent p-4 ps-6 relative -top-[100px] animate-navbar">
      <div className="mx-auto">
        <div className="flex items-center justify-between">
          <div className="md:w-1/12 md:left-0 w-1/6 relative left-[40%]">
          ...
          <div className="md:hidden">
            ...
            <div className={"h-full fixed top-0 right-0 bg-slate-900 transition-all duration-500 overflow-hidden " + (dd ? "w-[50%]": "w-0")}>
